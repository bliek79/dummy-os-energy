...
from .do_plan_store import sync_automatic_candidates
...
def build_do_plan_grid_support_sensors(coordinator: Any) -> list[Any]:
    ...
    class DummyOSPlanStoreBridgeSensor(DummyOSPlanReserveSOCSensor):
        ...
        def _calculate_result(self, snapshot: dict[str, Any]) -> dict[str, Any]:
            ...
            plan72_result = build_do_plan_72h(
                input_result=input_result,
                reserve_result=reserve_result,
        ...
        def _initial_result(self) -> dict[str, Any]:
            return {
                "status": "initializing", "valid": False, "candidate_count": 0,
                "candidates": [], "suppressed_candidates": [], "shadow_only": True,
                "shadow_store_write": True, "operational_plan_store_write": False,
                "active_use_permitted": False, "physical_execution_authority": False,
                "scheduler_invoked": False, "safety_chain_invoked": False,
                "service_calls_performed": False, "blockers": ["planner_calculation_pending"],
            }
    ...
    # The bridge and all Plan Store sensors share exactly one isolated runtime.
    return [
        DummyOSPlanGridSupportSensor(coordinator),
        DummyOSPlanStoreBridgeSensor(coordinator),
        *build_do_plan_store_sensors(coordinator, runtime),
    ]

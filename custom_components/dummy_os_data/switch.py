...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback) -> None:
    async_add_entities([DummyOSPresenceAwayScheduleEnabled(entry.runtime_data)])


class DummyOSPresenceAwayScheduleEnabled(SwitchEntity):
    _attr_name = "DO Presence Away Schedule Enabled"
    _attr_unique_id = "do_presence_away_schedule_enabled"
    _attr_suggested_object_id = "do_presence_away_schedule_enabled"
    ...
    @property
    def is_on(self) -> bool:
        return self.runtime.schedule_enabled
